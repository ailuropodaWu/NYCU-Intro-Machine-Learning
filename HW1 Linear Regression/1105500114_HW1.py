...
class LinearRegression:
    ...
    def get_mse_loss(self, prediction, ground_truth):
        # Return the value.
        return sum(np.square(prediction - ground_truth)) / prediction.shape[0]
        pass
...
if __name__ == "__main__":
    # Data Preparation
    train_df = DataFrame(read_csv("./Dataset/train.csv"))
